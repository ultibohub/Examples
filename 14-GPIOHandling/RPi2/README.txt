...
Another example demonstrating the peripherals available in Ultibo, this time using the GPIO to detect a switch being opened or closed and turning an LED on or off in response.
